      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 text-left mt-2">
            <h4>Technical User Information</h4>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?>">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Technical User Information</h3>
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <div class="form-group col-md-4 select_sm">
                        ...
                        <select class="form-control select2" name="party_id" id="party_id" data-placeholder="Select Party Name">
                          <option value="">Select Party Name</option>
                        </select>
                      </div>

                      <div class="form-group col-md-4 ">
                        <label>Enter Technical User Name</label>
                        <input type="text" class="form-control form-control-sm" name="technical_user_name" id="technical_user_name" value="" placeholder="Enter Technical User Name" >
                      </div>
                      ...
                      <div class="form-group col-md-4 ">
                        ...
                        <input type="number" class="form-control form-control-sm" name="mobile_no" id="mobile_no" value="" placeholder="Enter Mobile No." >
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 text-left">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label for="student_status" class="custom-control-label">Disable This Technical User Information</label>
                          </div>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List All Technical User Information</h3>
              </div>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <a href="<?php echo base_url() ?>Master/delete_student/<?php echo $list->student_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Technical User Information');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
