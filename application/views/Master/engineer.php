      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?>">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Engineer</h3>
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <div class="form-group col-md-6">
                        <label>Enter Engineer Name</label>
                        <input type="number" class="form-control form-control-sm" name="student_no" id="student_no" value="" placeholder="Enter Engineer Name" >
                      </div>

                      <div class="form-group col-md-6">
                        <label>Mobile No.</label>
                        <input type="number" class="form-control form-control-sm" name="mobile_no" id="mobile_no" value="" placeholder="Mobile No." >
                      </div>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="password" class="form-control form-control-sm" name="password" id="password" value="" placeholder="Password" >
                      </div>

                      <div class="form-group col-md-3 select_sm">
                        <label>Select Salary Type</label>
                        <select class="form-control select2" name="salary_type" id="salary_type" data-placeholder="Select Salary Type">
                      ...
                      <div class="form-group col-md-3">
                        <label>Salary</label>
                        <input type="number" class="form-control form-control-sm" name="salary" id="salary" value="" placeholder="Salary" >
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 text-left">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label for="student_status" class="custom-control-label">Disable This Engineer</label>
                          </div>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List All Engineer Information</h3>
              </div>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <a href="<?php echo base_url() ?>Master/delete_student/<?php echo $list->student_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Engineer Information');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
