      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?>">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Party Group</h3>
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <div class="form-group col-md-6 ">
                        <label>Enter Party Group Name</label>
                        <input type="text" class="form-control form-control-sm" name="party_group" id="party_group" value="" placeholder="Enter Party Group Name" >
                      </div>

                      <div class="form-group col-md-6 ">
                        <label>Enter Party Group Phone</label>
                        <input type="number" class="form-control form-control-sm" name="party_phone" id="party_phone" value="" placeholder="Enter Party Group Phone" >
                      </div>
                      ...
                      <div class="form-group col-md-6 ">
                        <label>Enter Party Group Email</label>
                        <input type="number" class="form-control form-control-sm" name="party_email" id="party_email" value="" placeholder="Enter Party Group Email" >
                      </div>

                      <div class="form-group col-md-6 ">
                        <label>Enter GST No.</label>
                        <input type="number" class="form-control form-control-sm" name="party_gst_no" id="party_gst_no" value="" placeholder="Enter GST No." >
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 text-left">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label for="student_status" class="custom-control-label">Disable This Party Group</label>
                          </div>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List All Party Group Information</h3>
              </div>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <a href="<?php echo base_url() ?>Master/delete_student/<?php echo $list->student_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Party Group Information');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
