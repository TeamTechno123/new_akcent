      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?>">
              <div class="card-header">
                <h3 class="card-title"> <?php if(isset($update)){ echo 'Update'; } else{ echo 'Add New'; } ?> Party Wise Info</h3>
                      ...
                      <div class="row">
                        <div class="col-md-6 text-left">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label for="student_status" class="custom-control-label">Disable This Party Wise Info</label>
                          </div>
                        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List All Party Wise Info</h3>
              </div>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <a href="<?php echo base_url() ?>Master/delete_student/<?php echo $list->student_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Party Wise Info');"><i class="fa fa-trash text-danger"></i></a>
                        </div>
                      </td>
