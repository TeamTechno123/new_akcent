                    ...
                    <div class="form-group col-md-12">
                      <table id="myTable" class="table table-bordered tbl_list">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <select class="form-control form-control-sm" name="equipment_type_id" id="equipment_type_id" data-placeholder="Equipment Type">
                                <option value="">Equipment Type</option>
                                <option >1</option>
                              </select>
                            </td>
                            <td>
                              <select class="form-control form-control-sm" name="company_id" id="company_id" data-placeholder="Select Company">
                                <option value="">Select Company</option>
                                <option >1</option>
                              </select>
                            </td>
                            <td class="wt_150">
                              <input type="text" class="form-control form-control-sm" name="stock_no" id="stock_no" value="" placeholder="Model No." required>
                            </td>
                            <td class="wt_150">
                              <input type="text" class="form-control form-control-sm" name="stock_no" id="stock_no" value="" placeholder="Serial No." required>
                            </td>
                            <td>
                              <select class="form-control form-control-sm" name="Warranty_id" id="Warranty_id" data-placeholder="In Warranty">
