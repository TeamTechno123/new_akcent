                ...
                <div class="card-body p-0" style="display: none;">
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post">
                    <div class="row px-3">
                      <div class="col-md-10">
                        <div class="row">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control form-control-sm" name="s_date" id="s_date" value="" placeholder="From Date" >
                          </div>

                          <div class="form-group col-md-4">
                            <label>To Date</label>
                            <input type="number" class="form-control form-control-sm" name="e_date" id="e_date" value="" placeholder="To Date" >
                          </div>
                          ...
                          <div class="form-group col-md-6 select_sm">
                            ...
                            <select class="form-control select2" name="party_id" id="party_id" data-placeholder=" Select Party ">
                      ...
                      <div class="col-md-2">
                        <div class="form-group col-md-2 text-right mt-5">
              ...
              <div class="col-md-12">
                <div class="card card-default">
                      ...
                      <div class="card-header">
                        <div class="row">
                          <div class="col-md-8">
                        <h5 class="card-title f-16">List All Sale Invoice</h5>
                      </div>
